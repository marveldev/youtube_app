const modalLeftNav = () => {
  return `
    <nav class="modal-left-nav">
      ...
      <div>
        <button><i class="material-icons">&#xe88a;</i><strong>Home</strong></button>
        <button class="icon"><i class='fas fa-fire'></i><strong>Trending</strong></button>
      ...
      <div>
        ...
        <button class="icon"><i class="fa fa-history"></i><strong>History</strong></button>
        <button><i class="material-icons">&#xe54d;</i><strong>Your movies</strong></button>
        <button><i class="material-icons">&#xe8b8;</i>Settings</button>
